...
class GHarfiEkrani extends StatefulWidget {

  @override
  State<GHarfiEkrani> createState() => _GHarfiEkraniState();
}

class _GHarfiEkraniState extends State<GHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: GHarfiKelimeVeAnlami().g_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(GHarfiKelimeVeAnlami().g_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(GHarfiKelimeVeAnlami().g_harfi_kelime_ve_Anlami[index].KelimeAnlami,
