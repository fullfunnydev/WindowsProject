...
class HarfiEkrani extends StatefulWidget {

  @override
  State<HarfiEkrani> createState() => _HarfiEkraniState();
}

class _HarfiEkraniState extends State<HarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: HHarfiKelimeVeAnlami().h_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(HHarfiKelimeVeAnlami().h_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(HHarfiKelimeVeAnlami().h_harfi_kelime_ve_Anlami[index].KelimeAnlami,
