...
class RHarfiEkrani extends StatefulWidget {

  @override
  State<RHarfiEkrani> createState() => _RHarfiEkraniState();
}

class _RHarfiEkraniState extends State<RHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: RHarfiKelimeVeAnlami().r_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(RHarfiKelimeVeAnlami().r_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(RHarfiKelimeVeAnlami().r_harfi_kelime_ve_Anlami[index].KelimeAnlami,
