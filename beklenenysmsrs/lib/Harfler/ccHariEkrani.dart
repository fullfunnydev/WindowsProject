...
class ccHarfiEkrani extends StatefulWidget {

  @override
  State<ccHarfiEkrani> createState() => _ccHarfiEkraniState();
}

class _ccHarfiEkraniState extends State<ccHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: CcHarfiKelimeVeAnlami().Cc_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(CcHarfiKelimeVeAnlami().Cc_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(CcHarfiKelimeVeAnlami().Cc_harfi_kelime_ve_Anlami[index].KelimeAnlami,
