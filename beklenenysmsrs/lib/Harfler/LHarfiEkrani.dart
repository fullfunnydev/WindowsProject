...
class LHarfiEkrani extends StatefulWidget {

  @override
  State<LHarfiEkrani> createState() => _LHarfiEkraniState();
}

class _LHarfiEkraniState extends State<LHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: LHarfiKelimeVeAnlami().l_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(LHarfiKelimeVeAnlami().l_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(LHarfiKelimeVeAnlami().l_harfi_kelime_ve_Anlami[index].KelimeAnlami,
