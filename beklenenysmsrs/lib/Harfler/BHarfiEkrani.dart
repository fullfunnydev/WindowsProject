...
class BHarfiEkrani extends StatefulWidget {

  @override
  State<BHarfiEkrani> createState() => _BHarfiEkraniState();
}

class _BHarfiEkraniState extends State<BHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: BharfiKelimeVeAnlami().b_Harfi_kelime_Ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(BharfiKelimeVeAnlami().b_Harfi_kelime_Ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(BharfiKelimeVeAnlami().b_Harfi_kelime_Ve_Anlami[index].KelimeAnlami,
