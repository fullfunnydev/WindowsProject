...
class JHarfiEkrani extends StatefulWidget {

  @override
  State<JHarfiEkrani> createState() => _JHarfiEkraniState();
}

class _JHarfiEkraniState extends State<JHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: JHarfiKelimeVeAnlami().j_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(JHarfiKelimeVeAnlami().j_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(JHarfiKelimeVeAnlami().j_harfi_kelime_ve_Anlami[index].KelimeAnlami,
