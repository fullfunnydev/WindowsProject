...
class MHarfiEkrani extends StatefulWidget {

  @override
  State<MHarfiEkrani> createState() => _MHarfiEkraniState();
}

class _MHarfiEkraniState extends State<MHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: MHarfiKelimeVeAnlami().m_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(MHarfiKelimeVeAnlami().m_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(MHarfiKelimeVeAnlami().m_harfi_kelime_ve_Anlami[index].KelimeAnlami,
