...
class OHarfiEkrani extends StatefulWidget {

  @override
  State<OHarfiEkrani> createState() => _OHarfiEkraniState();
}

class _OHarfiEkraniState extends State<OHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: OarfiKelimeVeAnlami().o_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(OarfiKelimeVeAnlami().o_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(OarfiKelimeVeAnlami().o_harfi_kelime_ve_Anlami[index].KelimeAnlami,
