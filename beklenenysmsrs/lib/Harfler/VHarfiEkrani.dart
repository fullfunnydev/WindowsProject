...
class VHarfiEkrani extends StatefulWidget {

  @override
  State<VHarfiEkrani> createState() => _VHarfiEkraniState();
}

class _VHarfiEkraniState extends State<VHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: VHarfiKelimeVeAnlami().v_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(VHarfiKelimeVeAnlami().v_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(VHarfiKelimeVeAnlami().v_harfi_kelime_ve_Anlami[index].KelimeAnlami,
