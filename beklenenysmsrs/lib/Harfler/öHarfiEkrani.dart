...
class OOOOHarfiEkrani extends StatefulWidget {

  @override
  State<OOOOHarfiEkrani> createState() => _OOOOHarfiEkraniState();
}

class _OOOOHarfiEkraniState extends State<OOOOHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: OoHarfiKelimeVeAnlami().oo_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(OoHarfiKelimeVeAnlami().oo_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(OoHarfiKelimeVeAnlami().oo_harfi_kelime_ve_Anlami[index].KelimeAnlami,
