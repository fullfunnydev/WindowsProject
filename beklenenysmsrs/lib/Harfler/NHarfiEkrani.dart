...
class NHarfiEkrani extends StatefulWidget {

  @override
  State<NHarfiEkrani> createState() => _NHarfiEkraniState();
}

class _NHarfiEkraniState extends State<NHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: NHarfiKelimeVeAnlami().n_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(NHarfiKelimeVeAnlami().n_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(NHarfiKelimeVeAnlami().n_harfi_kelime_ve_Anlami[index].KelimeAnlami,
