...
class iHarfiEkrani extends StatefulWidget {

  @override
  State<iHarfiEkrani> createState() => _iHarfiEkraniState();
}

class _iHarfiEkraniState extends State<iHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: iHarfiKelimeVeAnlami().i_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(iHarfiKelimeVeAnlami().i_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(iHarfiKelimeVeAnlami().i_harfi_kelime_ve_Anlami[index].KelimeAnlami,
