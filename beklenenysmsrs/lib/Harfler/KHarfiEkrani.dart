...
class KHarfiEkrani extends StatefulWidget {

  @override
  State<KHarfiEkrani> createState() => _KHarfiEkraniState();
}

class _KHarfiEkraniState extends State<KHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: KHarfiKelimeVeAnlami().k_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(KHarfiKelimeVeAnlami().k_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(KHarfiKelimeVeAnlami().k_harfi_kelime_ve_Anlami[index].KelimeAnlami,
