...
class SHarfiEkrani extends StatefulWidget {

  @override
  State<SHarfiEkrani> createState() => _SHarfiEkraniState();
}

class _SHarfiEkraniState extends State<SHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: SHarfiKelimeVeAnlami().s_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(SHarfiKelimeVeAnlami().s_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(SHarfiKelimeVeAnlami().s_harfi_kelime_ve_Anlami[index].KelimeAnlami,
