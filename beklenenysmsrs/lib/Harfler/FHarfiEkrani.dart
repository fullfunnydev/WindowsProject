...
class FHarfiEkrani extends StatefulWidget {

  @override
  State<FHarfiEkrani> createState() => _FHarfiEkraniState();
}

class _FHarfiEkraniState extends State<FHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: FHarfiKelimeVeAnlami().f_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(FHarfiKelimeVeAnlami().f_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(FHarfiKelimeVeAnlami().f_harfi_kelime_ve_Anlami[index].KelimeAnlami,
