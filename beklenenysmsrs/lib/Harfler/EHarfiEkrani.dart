...
class EHarfiEkrani extends StatefulWidget {

  @override
  State<EHarfiEkrani> createState() => _EHarfiEkraniState();
}

class _EHarfiEkraniState extends State<EHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: EHarfiKelimeVeAnlami().e_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(EHarfiKelimeVeAnlami().e_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(EHarfiKelimeVeAnlami().e_harfi_kelime_ve_Anlami[index].KelimeAnlami,
