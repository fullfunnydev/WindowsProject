...
class UHarfiEkrani extends StatefulWidget {

  @override
  State<UHarfiEkrani> createState() => _UHarfiEkraniState();
}

class _UHarfiEkraniState extends State<UHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: UHarfiKelimeVeAnlami().u_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(UHarfiKelimeVeAnlami().u_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(UHarfiKelimeVeAnlami().u_harfi_kelime_ve_Anlami[index].KelimeAnlami,
