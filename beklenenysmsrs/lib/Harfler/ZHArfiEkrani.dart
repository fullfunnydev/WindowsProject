...
class ZHarfiEkrani extends StatefulWidget {

  @override
  State<ZHarfiEkrani> createState() => _ZHarfiEkraniState();
}

class _ZHarfiEkraniState extends State<ZHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: ZHarfiKelimeVeAnlami().z_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(ZHarfiKelimeVeAnlami().z_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(ZHarfiKelimeVeAnlami().z_harfi_kelime_ve_Anlami[index].KelimeAnlami,
