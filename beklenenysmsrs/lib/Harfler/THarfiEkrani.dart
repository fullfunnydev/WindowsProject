...
class THarfiEkrani extends StatefulWidget {

  @override
  State<THarfiEkrani> createState() => _THarfiEkraniState();
}

class _THarfiEkraniState extends State<THarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: THarfiKelimeVeAnlami().t_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(THarfiKelimeVeAnlami().t_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(THarfiKelimeVeAnlami().t_harfi_kelime_ve_Anlami[index].KelimeAnlami,
