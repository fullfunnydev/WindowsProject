...
class AHarfiEkrani extends StatefulWidget {

  @override
  State<AHarfiEkrani> createState() => _AHarfiEkraniState();
}

class _AHarfiEkraniState extends State<AHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: AharfiKelimeVeAnlami().a_Harfi_kelime_Ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(AharfiKelimeVeAnlami().a_Harfi_kelime_Ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(AharfiKelimeVeAnlami().a_Harfi_kelime_Ve_Anlami[index].KelimeAnlami,
