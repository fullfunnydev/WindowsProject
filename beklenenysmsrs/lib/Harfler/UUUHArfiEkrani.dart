...
class UUUHarfiEkrani extends StatefulWidget {

  @override
  State<UUUHarfiEkrani> createState() => _UUUHarfiEkraniState();
}

class _UUUHarfiEkraniState extends State<UUUHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: UUHarfiKelimeVeAnlami().uu_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(UUHarfiKelimeVeAnlami().uu_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(UUHarfiKelimeVeAnlami().uu_harfi_kelime_ve_Anlami[index].KelimeAnlami,
