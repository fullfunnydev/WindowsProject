...
class DHarfiEkrani extends StatefulWidget {

  @override
  State<DHarfiEkrani> createState() => _DHarfiEkraniState();
}

class _DHarfiEkraniState extends State<DHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: DarfiKelimeVeAnlami().d_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(DarfiKelimeVeAnlami().d_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(DarfiKelimeVeAnlami().d_harfi_kelime_ve_Anlami[index].KelimeAnlami,
