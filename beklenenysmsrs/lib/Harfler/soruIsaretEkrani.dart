...
class SoruIsaretEkrani extends StatefulWidget {

  @override
  State<SoruIsaretEkrani> createState() => _SoruIsaretEkraniState();
}

class _SoruIsaretEkraniState extends State<SoruIsaretEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: SorusaretiHarfiKelimeVeAnlami().soruis_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(SorusaretiHarfiKelimeVeAnlami().soruis_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(SorusaretiHarfiKelimeVeAnlami().soruis_harfi_kelime_ve_Anlami[index].KelimeAnlami,
