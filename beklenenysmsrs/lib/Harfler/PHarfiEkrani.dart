...
class PHarfiEkrani extends StatefulWidget {

  @override
  State<PHarfiEkrani> createState() => _PHarfiEkraniState();
}

class _PHarfiEkraniState extends State<PHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: PHarfiKelimeVeAnlami().p_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(PHarfiKelimeVeAnlami().p_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(PHarfiKelimeVeAnlami().p_harfi_kelime_ve_Anlami[index].KelimeAnlami,
