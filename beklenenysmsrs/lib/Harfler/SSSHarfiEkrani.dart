...
class SSSHarfiEkrani extends StatefulWidget {

  @override
  State<SSSHarfiEkrani> createState() => _SSSHarfiEkraniState();
}

class _SSSHarfiEkraniState extends State<SSSHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: SsHarfiKelimeVeAnlami().ss_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(SsHarfiKelimeVeAnlami().ss_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(SsHarfiKelimeVeAnlami().ss_harfi_kelime_ve_Anlami[index].KelimeAnlami,
