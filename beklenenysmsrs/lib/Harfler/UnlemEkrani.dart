...
class UnlemHarfiEkrani extends StatefulWidget {

  @override
  State<UnlemHarfiEkrani> createState() => _UnlemHarfiEkraniState();
}

class _UnlemHarfiEkraniState extends State<UnlemHarfiEkrani> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: unlemHarfiKelimeVeAnlami().unlem_harfi_kelime_ve_Anlami.length,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(unlemHarfiKelimeVeAnlami().unlem_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(unlemHarfiKelimeVeAnlami().unlem_harfi_kelime_ve_Anlami[index].KelimeAnlami,
