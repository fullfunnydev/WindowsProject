...
class CHarfiEkrani extends StatefulWidget {

  @override
  State<CHarfiEkrani> createState() => _CHarfiEkraniState();
}

class _CHarfiEkraniState extends State<CHarfiEkrani> {
  @override
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(CHarfiKelimeVeAnlami().c_harfi_kelime_ve_Anlami[index].kelime,
                                ...
                                Expanded(
                                  ...
                                  child: Text(CHarfiKelimeVeAnlami().c_harfi_kelime_ve_Anlami[index].KelimeAnlami,
