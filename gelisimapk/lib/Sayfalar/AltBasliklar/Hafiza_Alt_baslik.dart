...
class Hafiza_Alt_Baslik extends StatefulWidget {
  @override
  State<Hafiza_Alt_Baslik> createState() => _Hafiza_Alt_BaslikState();
}

class _Hafiza_Alt_BaslikState extends State<Hafiza_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().Hafiza.length,
