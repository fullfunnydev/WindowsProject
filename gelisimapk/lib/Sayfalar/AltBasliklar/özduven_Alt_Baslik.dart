...
class Ozguven_Alt_Baslik extends StatefulWidget {
  @override
  State<Ozguven_Alt_Baslik> createState() => _Ozguven_Alt_BaslikState();
}

class _Ozguven_Alt_BaslikState extends State<Ozguven_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().Ozguven.length,
