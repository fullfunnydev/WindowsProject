...
class Diksiyon_Alt_Baslik extends StatefulWidget {
  @override
  State<Diksiyon_Alt_Baslik> createState() => _Diksiyon_Alt_BaslikState();
}

class _Diksiyon_Alt_BaslikState extends State<Diksiyon_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().Diksiyon.length,
