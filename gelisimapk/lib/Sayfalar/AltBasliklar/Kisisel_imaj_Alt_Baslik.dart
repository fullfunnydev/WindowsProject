...
class Kisisel_imaj_Alt_Baslik extends StatefulWidget {
  @override
  State<Kisisel_imaj_Alt_Baslik> createState() => _Kisisel_imaj_Alt_BaslikState();
}

class _Kisisel_imaj_Alt_BaslikState extends State<Kisisel_imaj_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().Kisisel_imaj.length,
