...
class Nlp_Alt_Baslik extends StatefulWidget {
  @override
  State<Nlp_Alt_Baslik> createState() => _Nlp_Alt_BaslikState();
}

class _Nlp_Alt_BaslikState extends State<Nlp_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().Nlp.length,
