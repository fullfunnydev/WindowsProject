...
class Etkili_iletisim_Alt_Baslik extends StatefulWidget {
  @override
  State<Etkili_iletisim_Alt_Baslik> createState() => _Etkili_iletisim_Alt_BaslikState();
}

class _Etkili_iletisim_Alt_BaslikState extends State<Etkili_iletisim_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().Etkili_iletisim.length,
