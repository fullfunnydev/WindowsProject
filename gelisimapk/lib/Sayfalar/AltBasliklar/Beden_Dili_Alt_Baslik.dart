...
class Beden_Dili_Alt_Baslik extends StatefulWidget {
  @override
  State<Beden_Dili_Alt_Baslik> createState() => _Beden_Dili_Alt_BaslikState();
}

class _Beden_Dili_Alt_BaslikState extends State<Beden_Dili_Alt_Baslik> {
  @override
      ...
      child: Scaffold(
        ...
        body: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: Kisiel_gelisim_ekrani_alt_baslik().BedenDili.length,
