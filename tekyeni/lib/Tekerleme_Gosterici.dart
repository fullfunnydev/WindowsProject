...
class _TekerlemeGostericiEkranState extends State<TekerlemeGostericiEkran> {
  ...
  _initBannerAd() {
    _bannerAd = BannerAd(
        size: AdSize.banner,
        adUnitId: 'ca-app-pub-3853518386312922/6953916810',
  ...
  void initAdd() {
    InterstitialAd.load(
        adUnitId:'ca-app-pub-3853518386312922/9042638501',
        request: AdRequest(),
                        ...
                        ileriGeriFonskiyonu: () {
                          setState(() {
                            ...
                            if(isload){
                              ...
                              switch(Sayiindex){
                                case 2:interstitialAd.show();
                                break;
                                case 4:interstitialAd.show();
                                break;
                                case 6:interstitialAd.show();
                                break;
                                case 8:interstitialAd.show();
                                break;
                                case 10:interstitialAd.show();
                                break;
                              }
                            }
                          });
